  ...
  def forward(
        ...
        **kwargs,
        ...
        if labels is not None:
            ...
            loss = 0.0*loss_fct(logits.reshape(-1, self.decoder.config.vocab_size), labels.view(-1))+loss_fct_lab(outputs,encoder_offn)
...
training_args = Seq2SeqTrainingArguments(
    ...
    fp16=True, 
    output_dir="./checkpoint_without_anything/",
    logging_steps=1,
    save_steps=8400,
    save_total_limit=2,
    eval_steps=8000,
